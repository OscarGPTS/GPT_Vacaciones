...
<body style="background-color: #cc2647;">
    <table role="presentation" cellspacing="0" cellpadding="0" width="100%" style="background-color: #cc2647;">
        <tbody>
            <tr><!--[if mso]>
 <td></td> <![endif]-->
                <td class="body-content" style="color: rgba(0,0,0,0);padding-top: 30px;padding-bottom: 30px;">
                    <table class="container" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation">
                        <tbody>
                            <tr>
                                <td class="container-content"
                                    style="border-radius: 5px;padding: 50px;background-color: #ffffff;border-color: rgba(255,255,255,0);">
                                    <table class="row h-align-left v-align-top" border="0" cellpadding="0"
...
<![endif]-->
                                                    <div class="col col-12">
                                                        <table class="col-table" width="100%" border="0"
                                                            cellpadding="0" cellspacing="0" role="presentation">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="col-content"><img class="img-fluid"
                                                                            src="https://res.cloudinary.com/gpt-services/image/upload/v1677776233/logotipo_GPT-HD_kavejf.png"
                                                                            width="154" height="63"></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div><!--[if mso]>
                                                                ...
                                                                <tr>
                                                                    <td class="col-content">
                                                                        ...
                                                                        <h1 class="text-center text-uppercase"
                                                                            style="color: #3f3f40;font-family: Roboto;">
                                                                            REQUISICIÓN DE Curso/Capacitación</h1>
                                                                        <table class="spacer" role="presentation"
                                                                            border="0" cellpadding="0"
                                                                            cellspacing="0"
                                                                            style="width:100%;height:25px;">
                                                                        ...
                                                                        <h3 style="color: #3f3f40;">Hola
                                                                            {{ $data['user']['nombre'] }},</h3>
                                                                        <p
                                                                            style="color: #838c95;font-family: Roboto, sans-serif;">
                                                                            Se requiere su atención para atender la
                                                                            siguiente solicitud</p>
                                                                        <h3
                                                                            style="color: #3f3f40;font-family: Roboto, sans-serif;">
                                                                            Folio: {{ $data['folio'] }}</h3>
                                                                        <h4
                                                                            style="color: #cc2647;font-family: Roboto, sans-serif;">
                                                                            Estatus: {{ $data['status'] }}</h4>
                                                                        <table class="table table-borderless"
                                                                            border="0" cellpadding="0"
                                                                            cellspacing="0"
                                                                            style="border-radius: 5px;background-color: #f8f7f8;">

                                                                            <tbody>
                                                                                <tr>
                                                                                    <td
                                                                                        style="color: #3f3f40;font-weight: bold;border-bottom: 1px solid #9ea3ac ;">
                                                                                        Solicitante</td>
                                                                                    <td
                                                                                        style="color: #3f3f40;border-bottom: 1px solid #9ea3ac ;">
                                                                                        {{ $data['solicitante'] }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
                                                                                        style="color: #3f3f40;font-weight: bold;border-bottom: 1px solid #9ea3ac ;">
                                                                                        Curso/Capacitación</td>
                                                                                    <td
                                                                                        style="color: #3f3f40;border-bottom: 1px solid #9ea3ac ;">
                                                                                        {{ $data['curso'] }}</td>
                                                                                </tr>
                                                                        ...
                                                                        <p
                                                                            style="color: #838c95;font-size: 14px;font-family: Roboto, sans-serif;">
                                                                            Ingrese a&nbsp;<a
                                                                                href="https://rrhh.satechenergy.com/"
                                                                                style="color: #cc2647;font-weight: bold;">&nbsp;rrhh.satechenergy.com</a>&nbsp;
                                                                            dando clic al siguiente botón.</p>
                                                                        <center>
                                                                            <table
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="btn-content"
                                                                                            style="background-color: #cc2647;">
                                                                                            <a
                                                                                                href="https://rrhh.satechenergy.com">Ver
                                                                                                solicitud</a></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
...
<![endif]-->
                                    ...
                                    <table class="spacer" role="presentation" border="0" cellpadding="0"
                                        cellspacing="0" style="width:100%;height:25px;">
                                        <tbody>
                                            <tr>
                                        ...
                                        style="color: #3f3f40;font-size: 12px;font-family: Roboto, sans-serif;">¿Tienes
                                        preguntas o el sistema presenta algún problema?, contáctenos a la siguiente
                                        dirección de correo electrónico <a href="mailto:sistema@gptservices.com"
                                            style="color: #cc2647;font-weight: bold;">sistema@gptservices.com</a>,
                                        nuestro equipo esta disponible para responder preguntas.</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
