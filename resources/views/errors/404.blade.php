            ...
            <div class="container">
                <div class="error-page1">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <h3>¡Uy! Esta página no se encuentra..</h3>
                        <p class="sub-content">La página a la que intenta acceder no está disponible en este momento. Esto puede deberse a que el recurso que desea consultar no existe, se ha movido o no cuenta con el permiso para poder verlo.</p>
                        <a class="btn btn-primary btn-lg" href="{{ route('home') }}">VOLVER A LA PÁGINA DE INICIO</a>
                    </div>
                </div>
            </div>
        </div>
