...
<head>
    ...
    <title>Solicitud Rechazada por Dirección</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Solicitud Rechazada por Dirección</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="error-message">
                <h3>Su solicitud de vacaciones ha sido rechazada</h3>
                <p style="margin: 5px 0;">Lamentablemente, la Dirección no ha podido aprobar su solicitud de vacaciones en este momento.</p>
            </div>
            ...
            <p style="margin-top: 25px; padding: 15px; background: #fef3c7; border-left: 3px solid #F9BE00; font-size: 14px;">
                <strong>Próximos pasos:</strong> Si tiene dudas sobre el motivo del rechazo o desea solicitar vacaciones en fechas alternativas, por favor contacte con su supervisor directo o con el Departamento de Recursos Humanos.
            </p>
            
            <p style="margin-top: 30px; font-size: 14px; color: #666666;">
                Su saldo de días de vacaciones permanece sin cambios.
            </p>
        </div>
