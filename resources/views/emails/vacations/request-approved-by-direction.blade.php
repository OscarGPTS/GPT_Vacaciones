...
<head>
    ...
    <title>Solicitud Aprobada por Dirección</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Solicitud Aprobada por Dirección</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="success-message">
                <h3>Su solicitud ha sido aprobada por Dirección</h3>
                <p style="margin: 5px 0;">La Dirección ha revisado y aprobado su solicitud de vacaciones. Ahora será enviada a Recursos Humanos para la aprobación final.</p>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="badge-success">APROBADA POR DIRECCIÓN</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Siguiente paso:</span> 
                    <strong>Aprobación de Recursos Humanos</strong>
                </div>
            </div>
            ...
            <p style="margin-top: 25px; padding: 15px; background: #e0f2fe; border-left: 3px solid #0284c7; font-size: 14px;">
                <strong>Importante:</strong> Su solicitud ha pasado el nivel de aprobación de Dirección. El Departamento de Recursos Humanos procesará su solicitud próximamente y recibirá una notificación con la decisión final.
            </p>
            
            <p style="margin-top: 30px; font-size: 14px; color: #666666;">
                Estamos trabajando para procesar su solicitud en el menor tiempo posible.
            </p>
        </div>
