...
<head>
    ...
    <title>Solicitud Rechazada por RH</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Solicitud de Vacaciones No Aprobada</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="warning-box">
                <h3>Su solicitud de vacaciones no ha sido aprobada</h3>
                <p style="margin: 5px 0;">Lamentamos informarle que el Departamento de Recursos Humanos ha rechazado su solicitud de vacaciones.</p>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    <span class="info-label">Rechazada por:</span> 
                    Recursos Humanos
                </div>
                <div class="info-row">
            ...
            <p style="margin-top: 25px; padding: 15px; background: #fef3c7; border-left: 3px solid #F9BE00; font-size: 14px;">
                <strong>Nota:</strong> Los días solicitados permanecen disponibles en su saldo de vacaciones.
            </p>
            
            <p style="margin-top: 30px; font-size: 14px; color: #666666;">
                Para conocer los motivos de esta decisión o resolver cualquier duda, le invitamos a contactar directamente con el Departamento de Recursos Humanos.
            </p>
        </div>
