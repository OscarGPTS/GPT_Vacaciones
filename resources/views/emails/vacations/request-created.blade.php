...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="greeting">Estimado(a) <strong>{{ $manager->first_name }} {{ $manager->last_name }}</strong>,</p>
            
            <p>Se ha recibido una nueva solicitud de vacaciones que requiere su revisión y aprobación.</p>
            ...
            <div class="days-list">
                <div class="days-list-title">Días específicos solicitados:</div>
            ...
            <p style="text-align: center;">
                <a href="{{ route('vacaciones.aprobar') }}" class="button">
                    REVISAR SOLICITUD
                </a>
            </p>

            <p style="color: #666666; font-size: 14px;">
                Por favor revise y procese esta solicitud a la brevedad posible a través del sistema.
            </p>
        </div>
