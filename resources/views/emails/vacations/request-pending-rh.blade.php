...
<head>
    ...
    <title>Solicitud Pendiente RH</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Solicitud de Vacaciones - Recursos Humanos</h1>
        </div>
        
        <div class="content">
            <p class="greeting">Estimado(a) Equipo de Recursos Humanos,</p>
            
            <p>Una solicitud de vacaciones ha sido aprobada por el Jefe directo y Dirección, y requiere su revisión y aprobación final.</p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    {{ $manager->first_name ?? 'N/A' }} {{ $manager->last_name ?? '' }} (Jefe Directo) y Dirección
                </div>
                <div class="info-row">
                    <span class="info-label">Estado:</span> 
                    <span class="badge">PENDIENTE RH</span>
                </div>
            </div>

            <center>
                <a href="{{ route('vacaciones.rh') }}" class="button">REVISAR SOLICITUD</a>
            </center>

            <p style="margin-top: 30px; font-size: 13px; color: #666666;">
                Por favor, revise esta solicitud en el sistema de Recursos Humanos a la brevedad posible.
            </p>
        </div>
