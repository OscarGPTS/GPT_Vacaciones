...
<head>
    ...
    <title>Solicitud de Vacaciones Cancelada</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Solicitud de Vacaciones Cancelada</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="warning-box">
                <h3>Su solicitud de vacaciones fue cancelada</h3>
                <p style="margin: 5px 0;">
                    El Departamento de Recursos Humanos ha cancelado esta solicitud. Los días reservados han sido devueltos a su saldo disponible del período correspondiente.
                </p>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    <span class="info-label">Días afectados:</span>
                    <strong>{{ $daysCount }} día(s)</strong>
                </div>
                <div class="info-row">
                    <span class="info-label">Cancelada por:</span>
                    {{ $cancelledBy->first_name }} {{ $cancelledBy->last_name }} (Recursos Humanos)
                </div>
            ...
            <p style="margin-top: 25px; padding: 15px; background: #ecfdf5; border-left: 3px solid #10b981; font-size: 14px;">
                <strong>Nota:</strong> Los días previamente reservados han sido liberados al saldo del período correspondiente.
            </p>

            <p style="margin-top: 30px; font-size: 14px; color: #666666;">
                Para conocer el motivo de la cancelación o resolver cualquier duda, le invitamos a contactar directamente con el Departamento de Recursos Humanos.
            </p>
        </div>
