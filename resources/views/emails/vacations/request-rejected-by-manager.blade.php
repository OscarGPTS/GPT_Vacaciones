    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="warning-box">
                ...
                <p style="margin: 5px 0;">Lamentamos informarle que su jefe directo ha rechazado su solicitud de vacaciones.</p>
            </div>
            ...
            <p style="margin-top: 30px; font-size: 14px; color: #666666;">
                Para conocer los motivos del rechazo o resolver cualquier duda, le sugerimos comunicarse directamente con su jefe directo.
            </p>
        </div>
