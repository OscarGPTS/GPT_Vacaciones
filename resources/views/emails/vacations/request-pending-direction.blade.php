...
<head>
    ...
    <title>Nueva Solicitud Pendiente</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="greeting">Estimado(a) <strong>miembro de Dirección</strong>,</p>
            
            <div class="info-message">
                <h3>Hay una nueva solicitud de vacaciones que requiere su aprobación</h3>
                <p style="margin: 5px 0;">Una solicitud de vacaciones ha sido aprobada por el jefe directo y ahora requiere su revisión y aprobación.</p>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <strong>{{ $employee->job->name }}</strong>
                </div>
                @endif
                @if($employee->job && $employee->job->departamento)
                <div class="info-row">
                    <span class="info-label">Departamento:</span> 
                    <strong>{{ $employee->job->departamento->name }}</strong>
                </div>
                @endif
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <strong>{{ $manager->first_name }} {{ $manager->last_name }}</strong> (Jefe Directo)
                </div>
                <div class="info-row">
                    <span class="info-label">Estado actual:</span> 
                    <span class="badge-warning">PENDIENTE DE DIRECCIÓN</span>
                </div>
            </div>

            <p style="margin-top: 25px; padding: 15px; background: #e0f2fe; border-left: 3px solid #0284c7; font-size: 14px;">
                <strong>Acción requerida:</strong> Por favor revise esta solicitud y proceda a aprobarla o rechazarla. Si es aprobada, pasará al Departamento de Recursos Humanos para su procesamiento final.
            </p>

            <div style="text-align: center;">
                <a href="{{ route('vacaciones.direccion') }}" class="action-button">
                    REVISAR SOLICITUD
                </a>
            </div>
            
            <p style="margin-top: 30px; font-size: 14px; color: #666666;">
                Por favor procese esta solicitud lo antes posible para no retrasar el proceso de aprobación.
            </p>
        </div>
