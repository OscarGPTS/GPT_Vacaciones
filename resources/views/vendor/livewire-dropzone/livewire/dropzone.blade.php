...
>
    <div class="p-3 rounded dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-max-w-2xl dz-justify-center dz-bg-white dark:dz-bg-gray-800 dark:dz-border-gray-600 dark:hover:dz-border-gray-500">
        @if(! is_null($error))
        ...
        <div class="dz-flex dz-justify-between dz-w-full">
            <label for="upload" class="dz-font-medium dz-text-lg dz-mb-2 dz-text-black dark:dz-text-white">Subir archivos <span class="dz-text-red-500">*</span></label>
        ...
        <div @click="$refs.input.click()" class="dz-border dz-border-dashed dz-rounded dz-border-gray-500 dz-w-full dz-cursor-pointer">
            <div>
                <div x-show="!isDragging" class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-2 dz-py-8 dz-h-full dark:dz-bg-gray-700">
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400">Soltar aquí o <span class="dz-font-semibold dz-text-black dark:dz-text-white">Examinar archivos</span></p>
                </div>
                <div x-show="isDragging" class="dz-flex dz-items-center dz-bg-gray-100 dz-justify-center dz-gap-2 dz-py-8 dz-h-full">
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400">Suelte aquí para cargar</p>
                </div>
            </div>
            <input
                    x-ref="input"
        ...
        <div class="dz-flex dz-items-center dz-gap-2 dz-text-gray-500 dz-text-sm dz-mt-2">
            ...
            @if($hasMaxFileSize)
                <p>{{ __('Hasta :size', ['size' => \Illuminate\Support\Number::fileSize($this->maxFileSize * 1024)]) }}</p>
            @endif
