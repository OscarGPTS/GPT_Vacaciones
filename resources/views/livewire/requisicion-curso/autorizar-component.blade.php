<div>
        ...
        <div class="col-md-12">
            <nav class="breadcrumb breadcrumb-icon">
                <li class="breadcrumb-item">
                    <a href="{{ route('dg.requisiciones.curso.index') }}">Lista de solicitudes</a>
                </li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            @if ($requisicion->status()->canBe('Rechazada por dirección general') || $requisicion->status()->canBe('Aceptada por dirección general'))
