                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0 text-black">
                                    ...
                                    Solicitudes de Vacaciones - Dirección
                                </h3>
                                <small class="text-black d-block mt-1 fs-5">Gestión de solicitudes de vacaciones desde Dirección</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills nav-fill mb-4" id="directionTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $statusFilter === 'pending' ? 'active' : '' }} text-start" 
                                    ...
                                    <small class="d-block mt-1">Solicitudes esperando aprobación de Dirección</small>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $statusFilter === 'processed' ? 'active' : '' }} text-start" 
                                    ...
                                    <small class="d-block mt-1">Solicitudes aprobadas por Dirección</small>
                                </button>
                            </li>
                        </ul>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-success text-white">
                                                                <h5 class="modal-title">
                                                                    <i class="fas fa-check-circle"></i> Aprobar Solicitud de Vacaciones - Dirección
                                                                </h5>
                                                            ...
                                                            <div class="modal-body bg-white">
                                                                ...
                                                                <div class="alert alert-success mt-3">
                                                                    ...
                                                                    <strong>Nota:</strong> Al aprobar, la solicitud será enviada automáticamente a Recursos Humanos para la aprobación final.
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-danger text-white">
                                                                <h5 class="modal-title">
                                                                    <i class="fas fa-times-circle"></i> Rechazar Solicitud de Vacaciones - Dirección
                                                                </h5>
                                                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body bg-white">
                                    ...
                                    @else
                                        <div class="text-center py-5">
                                            ...
                                            <p class="text-muted">
                                                ...
                                                @else
                                                    Aún no se han aprobado solicitudes desde Dirección.
                                                @endif
                                            </p>
                                        </div>
                                    @endif
