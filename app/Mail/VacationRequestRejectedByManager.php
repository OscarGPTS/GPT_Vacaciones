...
class VacationRequestRejectedByManager extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Solicitud de Vacaciones Rechazada por Jefe Directo',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.vacations.request-rejected-by-manager',
        );
    }
