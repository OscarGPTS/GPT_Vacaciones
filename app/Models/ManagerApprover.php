...
class ManagerApprover extends Model
{
    ...
    /**
     * Obtener el jefe asignado para un empleado específico.
     * Busca directamente por employee_id.
     * 
     * @param int $employeeId ID del empleado
     * @return int|null ID del jefe asignado
     */
    public static function getManagerForUser($employeeId)
    {
    ...
    /**
     * Obtener el jefe asignado para el departamento (método legacy, mantiene compatibilidad).
     * NOTA: Con la nueva implementación, se recomienda usar getManagerForUser directamente.
     * 
     * @param int $departamentoId ID del departamento
     * @return int|null ID del primer jefe activo encontrado
     */
